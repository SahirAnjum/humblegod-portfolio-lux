...
const MontExperienceSection = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      location: 'India',
      description: 'Built scalable data workflows for Spark NZ Limited. Specialized in business intelligence and data warehousing using MSBI suite. Earned Global Agile Certification.',
